...
import br.edu.uffs.cadastroObjetos.AndroidMultiPartEntity.ProgressListener;
...
public class UploadActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FILE_UPLOAD_URL = "http://"+sharedPreferences.getString("MEM1", "")+"/CadastroObjetos/create_objeto.php";

        nome.setText("Nome do Objeto: "+objeto.getNome());
        frase.setText("Frase: "+objeto.getFrase());
    ...
    private class UploadFileToServer extends AsyncTask<Void, Integer, String> {
        ...
        private String uploadFile() {
            ...
            try {
                ...
                entity.addPart("nome", new StringBody(objeto.getNome(), "text/plain", Charset.forName("UTF-8")));
                entity.addPart("frase", new StringBody(objeto.getFrase(), "text/plain", Charset.forName("UTF-8")));
        ...
        builder.setMessage(message).setTitle("Response from Servers")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent myIntent = new Intent(UploadActivity.this, ListaObjetos.class);
                        Integer localId = objeto.getLocal();
